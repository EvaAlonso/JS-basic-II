...
const postres = ["helado", "tarta", "patel"];
console.log(postres);
//Objetos
...
//Escribe tu código aquí
console.log("Mis postres son " + postres[0] + ", " + postres[1] + ", " + postres[2] + ".");
console.log(`Mi coder es ${coder.nombre} y tiene ${coder.edad} años`);
...
mayorDeEdad(12);
console.log("No deja cambiar el valor porque está guardada en una constante")
...
//tipoMascota(pet = "serpiente");
console.log("No deja cambiar el valor de una constante")
...
console.log("No deja cambiar el valor de una constante");
const weather1 = "frío";
let result1 = (weather1 === "soleado") ? "Me vestiré con un vestido" : "Me vestiré con pantalón";
...
//Ejercicio 13: Con un bucle for in imprime en pantalla todos los nombres, apellidos y su aporte a la sociedad de las programadoras de la historia contenidas en el array llamado 'programmers',
...
//Crea una función llamada calcularAreaRectangulo que tome dos parámetros (ancho y alto) y devuelva el área del rectángulo. Luego, llama a la función con diferentes 
//valores de ancho y alto y muestra el resultado en la consola.

//Escribe tu código aquí
function area(w, h){
    console.log(`El área del rectángulo de alto ${h} y ancho ${w} es ` + (w*h));
}
area(10, 20);
area(5, 9);